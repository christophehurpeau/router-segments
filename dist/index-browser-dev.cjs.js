...
var RoutePathType = t.type("RoutePathType", t.exactObject(t.property("completePath", t.string()), t.property("namedParams", t.array(t.string())), t.property("path", t.string()), t.property("regExp", t.ref("RegExp")), t.property("toPath", t.function(t.param("args", t.object()), t.return(t.string())))));

var SegmentRoutePathType = t.type("SegmentRoutePathType", t.exactObject(t.property("completePath", t.string()), t.property("namedParams", t.array(t.string())), t.property("path", t.string()), t.property("regExp", t.ref("RegExp"))));
...
var RouteMatchType = t.type('RouteMatchType', t.exactObject(t.property('namedParams', t.nullable(t.ref('Map', t.string(), t.string()))), t.property('otherParams', t.nullable(t.array(t.string()))), t.property('path', t.string()), t.property('ref', t.ref(RouteRefType$3)), t.property('route', t.ref(RouteType$1)), t.property('routePath', t.union(t.ref(SegmentRoutePathType$3), t.ref(RoutePathType$3)))));

var RouterType = t.type('RouterType', t.exactObject(t.property('find', t.function(t.param('path', t.string()), t.param('locale', t.nullable(t.string()), true), t.return(t.nullable(RouteMatchType)))), t.property('get', t.function(t.param('key', t.string()), t.return(t.nullable(t.ref(EndRouteType$1))))), t.property('toLocalizedPath', t.function(t.param('locale', t.string()), t.param('key', t.string()), t.param('args', t.any()), t.return(t.string()))), t.property('toPath', t.function(t.param('key', t.string()), t.param('args', t.any()), t.return(t.string())))));
