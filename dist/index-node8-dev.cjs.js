...
const RoutePathType = t.type("RoutePathType", t.exactObject(t.property("completePath", t.string()), t.property("namedParams", t.array(t.string())), t.property("path", t.string()), t.property("regExp", t.ref("RegExp")), t.property("toPath", t.function(t.param("args", t.object()), t.return(t.string())))));

const SegmentRoutePathType = t.type("SegmentRoutePathType", t.exactObject(t.property("completePath", t.string()), t.property("namedParams", t.array(t.string())), t.property("path", t.string()), t.property("regExp", t.ref("RegExp"))));
...
const SegmentRouterBuilderType = t.type('SegmentRouterBuilderType', SegmentRouterBuilderType => {
  return t.exactObject(t.property('add', t.function(t.param('path', t.string()), t.param('ref', t.ref(RouteRefType$3)), t.param('key', t.nullable(t.string()), true), t.return(t.void()))), t.property('addLocalized', t.function(t.param('localizedPaths', PathDictionaryType), t.param('ref', t.ref(RouteRefType$3)), t.param('key', t.nullable(t.string()), true), t.return(t.void()))), t.property('addLocalizedSegment', t.function(t.param('localizedPaths', PathDictionaryType), t.param('buildSegment', t.function(t.param('builder', SegmentRouterBuilderType), t.return(t.void()))), t.return(t.void()))), t.property('addSegment', t.function(t.param('path', t.string()), t.param('buildSegment', t.function(t.param('builder', SegmentRouterBuilderType), t.return(t.void()))), t.return(t.void()))), t.property('defaultRoute', t.function(t.param('ref', t.ref(RouteRefType$3)), t.param('key', t.nullable(t.string()), true), t.return(t.void()))));
});
...
const RouteMatchType = t.type('RouteMatchType', t.exactObject(t.property('namedParams', t.nullable(t.ref('Map', t.string(), t.string()))), t.property('otherParams', t.nullable(t.array(t.string()))), t.property('path', t.string()), t.property('ref', t.ref(RouteRefType$3)), t.property('route', t.ref(RouteType$1)), t.property('routePath', t.union(t.ref(SegmentRoutePathType$3), t.ref(RoutePathType$3)))));

const RouterType = t.type('RouterType', t.exactObject(t.property('find', t.function(t.param('path', t.string()), t.param('locale', t.nullable(t.string()), true), t.return(t.nullable(RouteMatchType)))), t.property('get', t.function(t.param('key', t.string()), t.return(t.nullable(t.ref(EndRouteType$1))))), t.property('toLocalizedPath', t.function(t.param('locale', t.string()), t.param('key', t.string()), t.param('args', t.any()), t.return(t.string()))), t.property('toPath', t.function(t.param('key', t.string()), t.param('args', t.any()), t.return(t.string())))));

const RouterBuilderType = t.type('RouterBuilderType', t.exactObject(t.property('add', t.function(t.param('path', t.string()), t.param('ref', t.ref(RouteRefType$3)), t.param('key', t.nullable(t.string()), true), t.return(t.void()))), t.property('addLocalized', t.function(t.param('localizedPaths', PathDictionaryType), t.param('ref', t.ref(RouteRefType$3)), t.param('key', t.nullable(t.string()), true), t.return(t.void()))), t.property('addLocalizedSegment', t.function(t.param('localizedPaths', PathDictionaryType), t.param('buildSegment', t.function(t.param('builder', SegmentRouterBuilderType), t.return(t.void()))), t.return(t.void()))), t.property('addSegment', t.function(t.param('path', t.string()), t.param('buildSegment', t.function(t.param('builder', SegmentRouterBuilderType), t.return(t.void()))), t.return(t.void()))), t.property('createRouter', t.function(t.return(RouterType))), t.property('getRoutes', t.function(t.return(RoutesType)))));
...
exports.RouteType = RouteType$1;
exports.RouteRefType = RouteRefType$3;
exports.RoutePathType = RoutePathType$3;
exports.SegmentRoutePathType = SegmentRoutePathType$3;
exports.LocaleType = LocaleType$3;
exports.PathDictionaryType = PathDictionaryType;
exports.SegmentRouterBuilderType = SegmentRouterBuilderType;
exports.RoutesType = RoutesType;
exports.RouteMapType = RouteMapType;
exports.RouteMatchType = RouteMatchType;
exports.RouterType = RouterType;
exports.RouterBuilderType = RouterBuilderType;
