...
var RouteType = exports.RouteType = _flowRuntime2.default.type('RouteType', _flowRuntime2.default.union(_flowRuntime2.default.ref(_EndRoute2.default), _flowRuntime2.default.ref(_LocalizedEndRoute2.default), _flowRuntime2.default.ref(_SegmentRoute2.default), _flowRuntime2.default.ref(_LocalizedSegmentRoute2.default)));

var SegmentRouteType = exports.SegmentRouteType = _flowRuntime2.default.type('SegmentRouteType', _flowRuntime2.default.union(_flowRuntime2.default.ref(_SegmentRoute2.default), _flowRuntime2.default.ref(_LocalizedSegmentRoute2.default)));

var EndRouteType = exports.EndRouteType = _flowRuntime2.default.type('EndRouteType', _flowRuntime2.default.union(_flowRuntime2.default.ref(_EndRoute2.default), _flowRuntime2.default.ref(_LocalizedEndRoute2.default)));
